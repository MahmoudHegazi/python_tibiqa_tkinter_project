...
def moveChamp(event):
    ...
    if event.keysym.lower() == 'right':
        ...
        if current_1d_demntion < (cWidth - champ_size):
            current_1d_demntion += champ_size 
            w.moveto(mychamp, current_1d_demntion, 0)
            print('Dim:' , current_1d_demntion)
        ##print('moved right')
        character_actions.append("right")        
    elif event.keysym.lower() == 'left':
        if current_1d_demntion > 0:
            current_1d_demntion -= champ_size 
            w.moveto(mychamp, current_1d_demntion, 0)
            print('Dim:' , current_1d_demntion)
